    ...
    ***************************************************************************** */ var t = function (
        ...
        for (n.__k = [], p = 0; p < t.length; p++)
            if (
                ...
                (f = v.ref) && h.ref != f && (D || (D = []), h.ref && D.push(h.ref, null, v), D.push(f, v.__c || y, v)),
                    null != y
                        ? (null == b && (b = y),
                            "function" == typeof v.type && null != v.__k && v.__k === h.__k ? (v.__d = l = T(v, l, e)) : (l = C(e, v, h, w, y, l)),
    ...
    function I(e, t, n, r, o, a, s, l, u) {
        ...
        try {
            e: if ("function" == typeof x) {
                if (
                    ((b = t.props),
                        (D = (c = x.contextType) && r[c.__c]),
                        (w = c ? (D ? D.props.value : c.__) : r),
                        n.__c
                            ? (E = (d = t.__c = n.__c).__ = d.__E)
                            : ("prototype" in x && x.prototype.render ? (t.__c = d = new x(b, w)) : ((t.__c = d = new y(b, w)), (d.constructor = x), (d.render = O)),
                            D && D.sub(d),
                                (d.props = b),
                            d.state || (d.state = {}),
                                (d.context = w),
                    ...
                    if (
                        (null == x.getDerivedStateFromProps && b !== h && null != d.componentWillReceiveProps && d.componentWillReceiveProps(b, w),
                        (!d.__e && null != d.shouldComponentUpdate && !1 === d.shouldComponentUpdate(b, d.__s, w)) || t.__v === n.__v)
                    ) {
                        (d.props = b),
                            (d.state = d.__s),
                        t.__v !== n.__v && (d.__d = !1),
        ...
        for (var m in o)
            for (var y = 0, E = Fn(o[m], n); y < E.length; y++) {
                var b,
                    D = E[y];
                f = u[(b = a[m]).defId];
                s.push({ def: b, ui: f, instance: null, range: D, isStart: !1, isEnd: !1 });
            }
        for (var c in i)
                    ...
                    (t.prototype.render = function () {
                        ...
                        return Co(Yo, { hookProps: d, classNames: a.dayHeaderClassNames, content: a.dayHeaderContent, defaultContent: Ea, didMount: a.dayHeaderDidMount, willUnmount: a.dayHeaderWillUnmount }, function (t, o, i, a) {
                            return Co(
                                ...
                                Co("div", { className: "fc-scrollgrid-sync-inner" }, Co("a", { "aria-label": n.format(s, Da), className: ["fc-col-header-cell-cushion", e.isSticky ? "fc-sticky" : ""].join(" "), ref: i }, a))
                            );
                        });
                    }),
                    t
                ...
                (t.prototype.render = function () {
                    ...
                    return Co(Sa, { unit: "day" }, function (e, t) {
                        return Co(
                            ...
                            i && i("day"),
                            n.map(function (e) {
                                return o ? Co(ba, { key: e.toISOString(), date: e, dateProfile: r, todayRange: t, colCnt: n.length, dayHeaderFormat: a }) : Co(wa, { key: e.getUTCDay(), dow: e.getUTCDay(), dayHeaderFormat: a });
                            })
                        );
                    });
                }),
    ...
    function fl(e, t, n, r, o, i, a) {
        ...
        for (
            ...
            for (var D = x.firstCol; D <= x.lastCol; D += 1) h[D].push({ seg: hl(x, D, D + 1, a), isVisible: !1, isAbsolute: !1, absoluteTop: 0, marginTop: 0 });
        }
        ...
        for (var w = 0, S = p; w < S.length; w++) {
            ...
            for (D = C.start; D < C.end; D += 1) (m[D] += 1), h[D].push({ seg: hl(x, D, D + 1, a), isVisible: !1, isAbsolute: !1, absoluteTop: 0, marginTop: 0 });
        }
                        ...
                        if (c)
                            for (var h = 0, v = t; h < v.length; h++) {
                                var g = v[h],
                                    ...
                                    w = "",
                                    S = "";
                                D && (l.isRtl ? ((S = 0), (w = c.lefts[m.lastCol] - c.lefts[m.firstCol])) : ((w = 0), (S = c.rights[m.firstCol] - c.rights[m.lastCol]))),
                                    f.push(
                                        Co(
                                            "div",
                                            {
                                                ...
                                                style: { visibility: b ? "" : "hidden", marginTop: D ? "" : g.marginTop, top: D ? g.absoluteTop : "", left: w, right: S },
                                            },
                                            il(m)
    ...
    var Sl = (function (e) {
        ...
        Tl = Bo({
            ...
            views: {
                dayGrid: { component: Dl, dateProfileGeneratorClass: Sl },
                ...
                (t.prototype.queryHit = function (e, t) {
                    ...
                    if (null != p && null != f) {
                        var h = this.props.cells[p],
                            ...
                            D = o.add(E, b),
                            w = o.add(D, c);
                        return { dateProfile: s, dateSpan: r({ range: { start: D, end: w }, allDay: !1 }, h.extraDateSpan), dayEl: a.els[p], rect: { left: a.lefts[p], right: a.rights[p], top: v, bottom: v + g }, layer: 0 };
                    }
                    return null;
                }),
                t
